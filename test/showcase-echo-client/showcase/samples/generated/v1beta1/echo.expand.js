...
function main() {
  // [START localhost_v1beta1_generated_Echo_Expand_async]
  /**
  ...
  async function callExpand() {
    ...
    // Run request
    const stream = await showcaseClient.expand(request);
  ...
  callExpand();
  // [END localhost_v1beta1_generated_Echo_Expand_async]
}
