...
import * as sequenceserviceModule from '../src';
...
describe('v1beta1.SequenceServiceClient', () => {
    describe('Common methods', () => {
        ...
        it('has port', () => {
            const port = sequenceserviceModule.v1beta1.SequenceServiceClient.port;
            assert(port);
        ...
        it('has initialize method and supports deferred initialization', async () => {
            ...
            assert.strictEqual(client.sequenceServiceStub, undefined);
            await client.initialize();
            assert(client.sequenceServiceStub);
        });
    ...
    describe('createSequence', () => {
        it('invokes createSequence without error', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes createSequence without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSequence(
                    request,
                    (err?: Error|null, result?: protos.google.showcase.v1beta1.ISequence|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createStreamingSequence', () => {
        it('invokes createStreamingSequence without error', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createStreamingSequence = stubSimpleCall(expectedResponse);
            const [response] = await client.createStreamingSequence(request);
            assert.deepStrictEqual(response, expectedResponse);
        });

        it('invokes createStreamingSequence without error using callback', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createStreamingSequence = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createStreamingSequence(
                    request,
                    (err?: Error|null, result?: protos.google.showcase.v1beta1.IStreamingSequence|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createStreamingSequence with error', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createStreamingSequence = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createStreamingSequence(request), expectedError);
        });

        it('invokes createStreamingSequence with closed client', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('getSequenceReport', () => {
        it('invokes getSequenceReport without error', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
        ...
        it('invokes getSequenceReport without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSequenceReport(
                    request,
                    (err?: Error|null, result?: protos.google.showcase.v1beta1.ISequenceReport|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getStreamingSequenceReport', () => {
        it('invokes getStreamingSequenceReport without error', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.showcase.v1beta1.GetStreamingSequenceReportRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.showcase.v1beta1.StreamingSequenceReport()
            );
            client.innerApiCalls.getStreamingSequenceReport = stubSimpleCall(expectedResponse);
            const [response] = await client.getStreamingSequenceReport(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getStreamingSequenceReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getStreamingSequenceReport as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes getStreamingSequenceReport without error using callback', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getStreamingSequenceReport = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getStreamingSequenceReport(
                    request,
                    (err?: Error|null, result?: protos.google.showcase.v1beta1.IStreamingSequenceReport|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getStreamingSequenceReport with error', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getStreamingSequenceReport = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getStreamingSequenceReport(request), expectedError);
            const actualRequest = (client.innerApiCalls.getStreamingSequenceReport as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getStreamingSequenceReport as SinonStub)
        ...
        it('invokes getStreamingSequenceReport with closed client', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('attemptSequence', () => {
        it('invokes attemptSequence without error', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('attemptStreamingSequence', () => {
        it('invokes attemptStreamingSequence without error', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.showcase.v1beta1.AttemptStreamingSequenceRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.showcase.v1beta1.AttemptStreamingSequenceResponse()
            );
            client.innerApiCalls.attemptStreamingSequence = stubServerStreamingCall(expectedResponse);
            const stream = client.attemptStreamingSequence(request);
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.showcase.v1beta1.AttemptStreamingSequenceResponse) => {
                    resolve(response);
                });
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.attemptStreamingSequence as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.attemptStreamingSequence as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });

        it('invokes attemptStreamingSequence with error', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.attemptStreamingSequence = stubServerStreamingCall(undefined, expectedError);
            const stream = client.attemptStreamingSequence(request);
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.showcase.v1beta1.AttemptStreamingSequenceResponse) => {
                    resolve(response);
        ...
        it('invokes attemptStreamingSequence with closed client', async () => {
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
            });
    ...
    describe('Path templates', () => {
        ...
        describe('streamingSequence', () => {
            const fakePath = "/rendered/path/streamingSequence";
            const expectedParameters = {
                streaming_sequence: "streamingSequenceValue",
            };
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            client.initialize();
            client.pathTemplates.streamingSequencePathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.streamingSequencePathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('streamingSequencePath', () => {
                const result = client.streamingSequencePath("streamingSequenceValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.streamingSequencePathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchStreamingSequenceFromStreamingSequenceName', () => {
                const result = client.matchStreamingSequenceFromStreamingSequenceName(fakePath);
                assert.strictEqual(result, "streamingSequenceValue");
                assert((client.pathTemplates.streamingSequencePathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });

        describe('streamingSequenceReport', () => {
            const fakePath = "/rendered/path/streamingSequenceReport";
            const expectedParameters = {
                streaming_sequence: "streamingSequenceValue",
            };
            const client = new sequenceserviceModule.v1beta1.SequenceServiceClient({
            ...
            client.initialize();
            client.pathTemplates.streamingSequenceReportPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.streamingSequenceReportPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('streamingSequenceReportPath', () => {
                const result = client.streamingSequenceReportPath("streamingSequenceValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.streamingSequenceReportPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchStreamingSequenceFromStreamingSequenceReportName', () => {
                const result = client.matchStreamingSequenceFromStreamingSequenceReportName(fakePath);
                assert.strictEqual(result, "streamingSequenceValue");
                assert((client.pathTemplates.streamingSequenceReportPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
    });
